...
export default class Footer extends Component {
  ...
  handleFooterLabelClick = () => {
    window.open(
      'https://github.com/sagarvadalia/Sagar-Vadalia-Website.git',
      '_blank'
    );
  };
      ...
      <Grid.Row columns={1} className="footerComponentMainRow">
        ...
        >
          <Button labelPosition={'left'} onClick={this.handleFooterLabelClick}>
            ...
            <Button compact circular animated={'vertical'} color={'black'}>
              <Button.Content visible> Sagar Vadalia </Button.Content>{' '}
        ...
        >
          <Button
            ...
            compact
            circular
            onClick={this.handleFooterLabelClick}
          >
            <Button.Content>
              <Icon name="hand point right outline" /> Click to see the source
              code! <Icon name="hand point left outline" />
            </Button.Content>{' '}
          </Button>{' '}
        </Grid.Column>{' '}
      </Grid.Row>
